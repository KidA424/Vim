...
syn match     cypherComment       "--.*"
syn keyword   cypherKeyword       cypher start create match optional merge delete detach where return with unique union all set foreach unwind
